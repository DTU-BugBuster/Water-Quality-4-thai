...
.method public parseBody(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 178
    new-instance v1, Lorg/ksoap2/SoapFault;

    invoke-direct {v1, v0}, Lorg/ksoap2/SoapFault;-><init>(I)V

    goto :goto_0

    .line 180
    :cond_0
    new-instance v1, Lorg/ksoap2/SoapFault12;

    invoke-direct {v1, v0}, Lorg/ksoap2/SoapFault12;-><init>(I)V

    .line 182
    :goto_0
    invoke-virtual {v1, p1}, Lorg/ksoap2/SoapFault;->parse(Lorg/xmlpull/v1/XmlPullParser;)V
