...
.method private createDigestHeader(Lcz/msebera/android/httpclient/auth/Credentials;Lcz/msebera/android/httpclient/HttpRequest;)Lcz/msebera/android/httpclient/Header;
    ...
    .line 261
    invoke-virtual {v1, v9}, Lcz/msebera/android/httpclient/impl/auth/DigestScheme;->getParameter(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_2
    :try_start_0
    invoke-static {v10}, Lcz/msebera/android/httpclient/impl/auth/DigestScheme;->createMessageDigest(Ljava/lang/String;)Ljava/security/MessageDigest;
    ...
    .line 302
    iget-wide v12, v1, Lcz/msebera/android/httpclient/impl/auth/DigestScheme;->nounceCount:J

    add-long/2addr v12, v5

    iput-wide v12, v1, Lcz/msebera/android/httpclient/impl/auth/DigestScheme;->nounceCount:J
    ...
    .line 306
    iput-object v4, v1, Lcz/msebera/android/httpclient/impl/auth/DigestScheme;->lastNonce:Ljava/lang/String;
    ...
    iput-object v8, v1, Lcz/msebera/android/httpclient/impl/auth/DigestScheme;->cnonce:Ljava/lang/String;
    ...
    .line 319
    iput-object v8, v1, Lcz/msebera/android/httpclient/impl/auth/DigestScheme;->a2:Ljava/lang/String;
    ...
    invoke-static {v12, v9}, Lcz/msebera/android/httpclient/util/EncodingUtils;->getBytes(Ljava/lang/String;Ljava/lang/String;)[B
    ...
    invoke-static {v12}, Lcz/msebera/android/httpclient/impl/auth/DigestScheme;->encode([B)Ljava/lang/String;
    ...
    iget-object v12, v1, Lcz/msebera/android/httpclient/impl/auth/DigestScheme;->cnonce:Ljava/lang/String;
    ...
    iput-object v12, v1, Lcz/msebera/android/httpclient/impl/auth/DigestScheme;->a1:Ljava/lang/String;
    ...
    .line 340
    :goto_5
    iget-object v10, v1, Lcz/msebera/android/httpclient/impl/auth/DigestScheme;->a1:Ljava/lang/String;

    invoke-static {v10, v9}, Lcz/msebera/android/httpclient/util/EncodingUtils;->getBytes(Ljava/lang/String;Ljava/lang/String;)[B
    ...
    .line 361
    :cond_d
    new-instance v15, Lcz/msebera/android/httpclient/impl/auth/HttpEntityDigester;

    invoke-direct {v15, v12}, Lcz/msebera/android/httpclient/impl/auth/HttpEntityDigester;-><init>(Ljava/security/MessageDigest;)V

    if-eqz v0, :cond_e

    .line 364
    :try_start_1
    invoke-interface {v0, v15}, Lcz/msebera/android/httpclient/HttpEntity;->writeTo(Ljava/io/OutputStream;)V

    .line 366
    :cond_e
    invoke-virtual {v15}, Lcz/msebera/android/httpclient/impl/auth/HttpEntityDigester;->close()V
    :try_end_1
    ...
    invoke-virtual {v15}, Lcz/msebera/android/httpclient/impl/auth/HttpEntityDigester;->getDigest()[B
    ...
    invoke-static {v0, v9}, Lcz/msebera/android/httpclient/util/EncodingUtils;->getBytes(Ljava/lang/String;Ljava/lang/String;)[B
    ...
    invoke-direct {v5, v9}, Lcz/msebera/android/httpclient/util/CharArrayBuffer;-><init>(I)V
    ...
    .line 397
    invoke-virtual {v5, v9}, Lcz/msebera/android/httpclient/util/CharArrayBuffer;->append(Ljava/lang/String;)V
    ...
    invoke-direct {v10, v11, v14}, Lcz/msebera/android/httpclient/message/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v10, v11, v3}, Lcz/msebera/android/httpclient/message/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3, v10, v4}, Lcz/msebera/android/httpclient/message/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3, v0}, Lcz/msebera/android/httpclient/message/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_b
    invoke-direct {v0, v2, v3}, Lcz/msebera/android/httpclient/message/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v2, v6}, Lcz/msebera/android/httpclient/message/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v2, v7}, Lcz/msebera/android/httpclient/message/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v5, v2, v3}, Lcz/msebera/android/httpclient/message/BasicHeaderValueFormatter;->formatNameValuePair(Lcz/msebera/android/httpclient/util/CharArrayBuffer;Lcz/msebera/android/httpclient/NameValuePair;Z)Lcz/msebera/android/httpclient/util/CharArrayBuffer;
